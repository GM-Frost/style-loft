            ...
            >
                <Box  display = "flex" justifyContent="space-between">
                    ...
                    <Box display="flex" alignItems="center" backgroundColor={shades.neutral[100]} borderRadius="3px">
                        ...
                        <Typography color={shades.secondary[300]}>{count}</Typography>
                    ...
                    <Button
                        ...
                        sx = {{borderRadius:"3px", backgroundColor: shades.secondary[300], color:"white",'&:hover':{ backgroundColor:shades.secondary[400],color:'white'}}}
                    >
                        ADD TO CART
                    </Button>
                </Box>
